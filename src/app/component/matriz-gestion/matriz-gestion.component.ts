...
@Component({
  selector: 'app-matriz-gestion',
  templateUrl: './matriz-gestion.component.html',
  styleUrls: ['./matriz-gestion.component.scss']
})
export class MatrizGestionComponent implements OnInit {
